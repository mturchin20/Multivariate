...
##GEFOS2 -- "...HapMap(37) Phase 2 release 22 using Genome Build 36..." dbSNP (source: http://www.nature.com/ng/journal/v44/n5/full/ng.2249.html), 34 <5e-8 82 <5e-6 GWAS, N=~33k for FN, ~32k for LS
##20150806
...
~~~
[  mturchin20@spudling26  /mnt/gluster/data/external_public_supp/GEFOS2]$zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | awk '{ print $2 }' | sort | uniq -c
993668 chr1
602274 chr10
315 chr10_random
595364 chr11
...
mkdir /mnt/gluster/data/external_public_supp/GEFOS2 
cd /mnt/gluster/data/external_public_supp/GEFOS2
...
~~~
[  mturchin20@spudling26  /mnt/gluster/data/external_public_supp/GEFOS2]$for i in `ls -lrt | awk '{ print $9 }' | grep BMD`; do zcat $i | head -n 5 ; done              MarkerName      Allele1 Allele2 P-value Direction       Freq.Allele1.HapMapCEU
...
[  mturchin20@spudling26  /mnt/gluster/data/external_public_supp/GEFOS2]$for i in `ls -lrt | awk '{ print $9 }' | grep BMD`; do zcat $i | wc | xargs echo $i ; done     
...
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_MEN_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_MEN_GC.wUCSCGB_snp126.vs3.txt.gz &
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_WOMEN_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_WOMEN_GC.wUCSCGB_snp126.vs3.txt.gz &
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_POOLED_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_FNBMD_POOLED_GC.wUCSCGB_snp126.vs3.txt.gz &
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_MEN_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_MEN_GC.wUCSCGB_snp126.vs3.txt.gz &
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_WOMEN_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_WOMEN_GC.wUCSCGB_snp126.vs3.txt.gz &
python /mnt/lustre/home/mturchin20/Lab_Stuff/StephensLab/Multivariate/Python.PerlVLookup.FindrsIDsindbSNPvcf.vs3.py --file1 <(zcat /mnt/lustre/home/mturchin20/Data/UCSC/GenomeBrowser/snp126.txt.gz | perl -lane 'if ($F[1] =~ m/(chr[0-9MXY]+)_.*/) { $F[1] = $1; } print join("\t", @F);') --file2 /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_POOLED_GC.txt.gz | gzip > /mnt/gluster/data/external_public_supp/GEFOS2/GEFOS2_LSBMD_POOLED_GC.wUCSCGB_snp126.vs3.txt.gz &
...
~~~
[  mturchin20@spudling26  /mnt/gluster/data/external_public_supp/EGG]$for i in `ls -lrt | awk '{ print $9 }' | grep gz$`; do zcat $i | head -n 5; done
