...
BMI=read.table("/mnt/gluster/data/external_public_supp/GIANT2014_5/SNP_gwas_mc_merge_nogc.tbl.uniq.wUCSCGenomeBrowser_dbSNP130.vs1.MatchedToHeight.IncAllele.gz",header=T)
WHRadjBMI=read.table("/mnt/gluster/data/external_public_supp/GIANT2014_5/GIANT_2015_WHRadjBMI_COMBINED_EUR.wUCSCGenomeBrowser_dbSNP130.vs1.HeaderFix.MatchedToHeight.IncAllele.txt.gz",header=T)
...
> head(BMI)
  MarkerName A1 A2 Freq1.Hapmap      b     se        p      N        ChrBP
1  rs1000000  G  A       0.6333 0.0001 0.0044 -0.98190 231410 12_125456932
2 rs10000010  C  T       0.4250 0.0029 0.0030 -0.33740 322079   4_21227771
3 rs10000012  C  G       0.8083 0.0095 0.0054  0.07853 233933    4_1347324
4 rs10000013  C  A       0.1667 0.0095 0.0044 -0.03084 233886   4_36901463
5 rs10000017  T  C       0.2333 0.0034 0.0046  0.45980 233146   4_84997148
6 rs10000023  G  T       0.4083 0.0024 0.0038 -0.52770 233860   4_95952928
    GC.Zscore
1 -0.02268693
2 -0.95931516
...
> head(WHRadjBMI)
  MarkerName Allele1 Allele2 FreqAllele1HapMapCEU      b     se     p      N
1  rs1000000       G       A               0.6333 0.0056 0.0050 -0.26 142677
2 rs10000010       T       C               0.5750 0.0042 0.0034  0.23 209833
3 rs10000012       C       G               0.8083 0.0092 0.0061  0.13 142699
4 rs10000013       A       C               0.8333 0.0027 0.0050  0.59 142702
5 rs10000017       T       C               0.2333 0.0001 0.0051  0.98 142477
6 rs10000023       G       T               0.4083 0.0060 0.0043 -0.16 142369
         ChrBP   GC.Zscore
1 12_125456932 -1.12639113
2   4_21227771  1.20035886
3    4_1347324  1.51410189
4   4_36901463  0.53883603
5   4_84997148  0.02506891
6   4_95952928 -1.40507156
#~~~
...
write.table(file="GIANT2014_5.Orig3.dtsignif.vs1.SignCrrct.vs1.txt",dtsignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.Orig3.dtsignif.rs.vs1.SignCrrct.vs1.txt",dtsignif$rs,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.Orig3.dtlesssignif.vs1.SignCrrct.vs1.txt",dtlesssignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.Orig3.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",dtlesssignif$rs,sep=",",row.names=F,quote=F)
#write.table(file="GIANT2014_5.Orig3.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",paste(dtlesssignif$rs,"[[:space:]]",sep=""),row.names=F,quote=F)

write.table(file="GIANT2014_5.Orig3.RSS0.vs1.SignCrrct.vs1.txt",RSS0,row.names=F,sep=",",quote=F)
...
> quantile(dt2$mvp)
          0%          25%          50%          75%         100% 
2.274717e-07 1.707248e-01 4.251895e-01 9.246815e-01 1.590257e+02 
> quantile(dt2$unip)
          0%          25%          50%          75%         100% 
4.364805e-03 5.086383e-01 8.317973e-01 1.376854e+00 1.574949e+02 
> 
#~~~
...
write.table(file="GIANT2014_5.AllPheno.dtsignif.vs1.SignCrrct.vs1.txt",dtsignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.AllPheno.dtsignif.rs.vs1.SignCrrct.vs1.txt",dtsignif$rs,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.AllPheno.dtlesssignif.vs1.SignCrrct.vs1.txt",dtlesssignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2014_5.AllPheno.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",dtlesssignif$rs,sep=",",row.names=F,quote=F)
#write.table(file="GIANT2014_5.AllPheno.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",paste(dtlesssignif$rs,"[[:space:]]",sep=""),row.names=F,quote=F)

write.table(file="GIANT2014_5.AllPheno.RSS0.vs1.SignCrrct.vs1.txt",RSS0,row.names=F,sep=",",quote=F)
