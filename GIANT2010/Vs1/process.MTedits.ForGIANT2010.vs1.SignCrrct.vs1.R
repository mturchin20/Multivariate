...
BMI=read.table("/mnt/gluster/data/external_public_supp/GIANT2010/GIANT_BMI_Speliotes2010_publicrelease_HapMapCeuFreq.MatchedToHeight.txt.gz", header=T)
WHRadjBMI=read.table("/mnt/gluster/data/external_public_supp/GIANT2010/GIANT_WHRadjBMI_Heid2010_publicrelease_HapMapCeuFreq.MatchedToHeight.txt.gz", header=T)
...
> head(BMI)
  MarkerName Allele1 Allele2 Freq.Allele1.HapMapCEU       p      N   GC.Zscore
1  rs1000000       g       a                 0.6333 -0.5060 123865 -0.66507895
2 rs10000010       c       t                  0.425 -0.7360 123827 -0.33715508
3 rs10000012       c       g                 0.8083  0.0420 123809  2.03352015
4 rs10000013       c       a                 0.1667 -0.0689 123863 -1.81907493
5 rs10000017       t       c                 0.2333  0.4570 123262  0.74379584
6 rs10000023       t       g                 0.5917  0.9390 123756  0.07652679
> head(WHRadjBMI)
  MarkerName Allele1 Allele2 Freq.Allele1.HapMapCEU       p     N   GC.Zscore
1  rs1000000       g       a                 0.6333 -0.5500 77168 -0.59776013
2 rs10000010       t       c                  0.575  0.0029 77152  2.97814368
3 rs10000012       g       c                 0.1917 -0.9900 77117 -0.01253347
4 rs10000013       a       c                 0.8333  0.8900 77167  0.13830421
5 rs10000017       c       t                 0.7667 -0.6400 77166 -0.46769880
6 rs10000023       g       t                 0.4083 -0.0410 77140 -2.04353001
...
> RSS0
                  Z.BMI     Z.height  Z.WHRadjBMI
Z.BMI        1.00000000 -0.027725473  0.014219039
Z.height    -0.02772547  1.000000000 -0.003343668
Z.WHRadjBMI  0.01421904 -0.003343668  1.000000000
...
write.table(file="GIANT2010.dtsignif.vs1.SignCrrct.vs1.txt",dtsignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtsignif.rs.vs1.SignCrrct.vs1.txt",dtsignif$rs,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtlesssignif.vs1.SignCrrct.vs1.txt",dtlesssignif,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",dtlesssignif$rs,sep=",",row.names=F,quote=F)
#write.table(file="GIANT2010.dtlesssignif.rs.vs1.SignCrrct.vs1.txt",paste(dtlesssignif$rs,"[[:space:]]",sep=""),row.names=F,quote=F)

write.table(file="GIANT2010.RSS0.vs1.SignCrrct.vs1.txt",RSS0,row.names=F,sep=",",quote=F)
...
> quantile(dt2$mvp)
          0%          25%          50%          75%         100% 
1.457458e-08 1.284949e-01 3.159959e-01 6.570938e-01 6.033335e+01 
> quantile(dt2$unip)
          0%          25%          50%          75%         100% 
 0.001740662  0.438898616  0.703115524  1.099086932 61.688246139 
#~~~
...
write.table(file="GIANT2010.dtsignif_lte3.vs1.SignCrrct.vs1.txt",dtsignif_lte3,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtsignif_lte3.rs.vs1.SignCrrct.vs1.txt",dtsignif_lte3$rs,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtlesssignif_lte3.vs1.SignCrrct.vs1.txt",dtlesssignif_lte3,sep=",",row.names=F,quote=F)
write.table(file="GIANT2010.dtlesssignif_lte3.rs.vs1.SignCrrct.vs1.txt",dtlesssignif_lte3$rs,sep=",",row.names=F,quote=F)
#write.table(file="GIANT2010.dtlesssignif_lte3.rs.vs1.SignCrrct.vs1.txt",paste(dtlesssignif_lte3$rs,"[[:space:]]",sep=""),row.names=F,quote=F)

write.table(file="GIANT2010.RSS0_lte3.vs1.SignCrrct.vs1.txt",RSS0_lte3,row.names=F,sep=",",quote=F)
